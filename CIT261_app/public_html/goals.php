        <div id="input">
            <p>Please input values for your current goals.</p>
	    ...
	    <label>Calf Raises:</label><input type="number" id="calves" max="999" min="0"><input type="number" id="calveset" max="99" min="0"><br>
