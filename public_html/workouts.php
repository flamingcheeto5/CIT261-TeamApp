<div id="input">
	<p>Please enter ACTUAL values for your workout.<p>
	...
	<A HREF="javascript:history.go(0)"><button class="wiggle" type = "button" onClick = "saveDataInLSWorkouts()">Store Results</button><A/>
</div>
